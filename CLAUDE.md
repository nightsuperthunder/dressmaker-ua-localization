...
- Releases: v1.0.0 … **v1.2.4** (latest). Listed on kuli.com.ua? — form data: Steam appid **4019220**, platform Windows only, category «Неофіційні», type «Текст», author `nightsuperthunder`, screenshots in `docs/screenshots/*.png` (raw.githubusercontent links).
