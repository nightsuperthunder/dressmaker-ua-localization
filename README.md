# Українізатор Dressmaker — українська локалізація гри

**Українізатор для гри Dressmaker (Steam, Windows).** Фанатський переклад Dressmaker українською мовою: затишний симулятор кравчині в місті Твіллфорд у стилі епохи Регентства тепер можна пройти повністю українською.

**[⬇ Завантажити українізатор (остання версія)](../../releases/latest)**
...
1. Завантажте `DressmakerUA-vX.Y.Z.zip` з [останнього релізу](../../releases/latest).
